...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-count-if/tags). For example,

```javascript
countIf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-count-if@v0.1.1-umd/browser.js' )
```
